public static class ConsumiveisProntos{
    public static Consumivel[] geraItens(){
        ...
        Consumivel pocaoVidaP = new Consumivel("Poção de Vida Pequena", 5, 1, 1, "vida", 20);

        Consumivel pocaoVidaM = new Consumivel("Poção de Vida Media", 20, 1, 1, "vida", 50);

        Consumivel pocaoVidaG = new Consumivel("Poção de Vida Grande", 65, 1, 1, "vida", 100);
        //////////////////
