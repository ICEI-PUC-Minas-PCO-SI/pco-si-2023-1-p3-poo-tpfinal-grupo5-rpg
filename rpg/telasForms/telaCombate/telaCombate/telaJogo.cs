...
namespace telaCombate
{
    public partial class telaJogo : Form
    {
        ...
        public telaJogo(Raca racaSelecionada, Classe classeSelecionada)
        {
            InitializeComponent();
            InitializeHistoria();
        ...
        {
            textoIntro.Text = "Max é um jovem comum, que vive uma vida comum, com seus afazeres comuns, em uma pacata vila.";
        }
        private void InitializeHistoria()
        {
            historia = new List<string>
            {
                ...
                "Max começa a perceber também que o comportamento do ancião do vilarejo, o senhor Orion, estava muito alterado: O velho corria pra lá e pra cá, fazendo rituais e em estado de negação.",
        ...
        private void btnProsseguir_Click(object sender, EventArgs e)
        {
            ...
            if (indiceAtual >= historia.Count)
            {
                ...
                telaNPCs formsNPCs = new telaNPCs(racaSelecionada, classeSelecionada);
                formsNPCs.Show();
                this.Hide();
